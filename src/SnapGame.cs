...
namespace CardGames
{
    public class SnapGame
    {
        public static void LoadResources()
        {
			...
			SwinGame.LoadFontNamed("GameFont", "Chunkfive.otf", 53);
        }
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText("" + myGame.Score(0), Color.White, "GameFont", 65, 30);
				SwinGame.DrawText("" + myGame.Score(1), Color.White, "GameFont", 755, 30);
